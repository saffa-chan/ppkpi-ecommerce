    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($query)) : ?>
            <tr>
                ...
                <td><img class="img-thumbnail" width="70px" src="upload/<?php echo $row['foto'] ?>" alt=""></td>
                <td><a href="?pg=tambah-produk&edit=<?php echo $row['id'] ?>" class="btn btn-xs btn-danger">Edit</a> |
