    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($query)) : ?>
            <tr>
                ...
                <td>
                    <a href="?pg=tambah-level&edit=<?php echo $row['id'] ?>" class=" btn btn-sm btn btn-danger">Edit</a>|
                    <a onclick="return confirm('Are you sure wanted removed this?')" href="?pg=level&delete=<?php echo $row['id'] ?>" class=" btn btn-xs btn btn-success">Delete</a>|
                </td>
            </tr>
        <?php endwhile ?>
    </tbody>
